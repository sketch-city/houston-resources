...
},{"./constants":"js/constants.js","lodash/isArray":"node_modules/lodash/isArray.js","axios":"node_modules/axios/index.js","./data-mapper":"js/data-mapper.js","./search-filter-store":"js/search-filter-store.js"}],"js/components/labelled.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"lodash/isEmpty":"node_modules/lodash/isEmpty.js","preact":"node_modules/preact/dist/preact.mjs"}],"js/components/labelled-item.js":[function(require,module,exports) {
"use strict";
...
var LabelledItem = function LabelledItem(_ref) {
  ...
  return (0, _preact.h)(_labelled.default, {
    ...
    attribute: attribute,
    groups: groups
  }, !(0, _isEmpty.default)(item) && item || 'n/a');
};

var _default = LabelledItem;
exports.default = _default;
},{"lodash/isEmpty":"node_modules/lodash/isEmpty.js","preact":"node_modules/preact/dist/preact.mjs","./labelled":"js/components/labelled.js"}],"js/components/agency-phone.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"preact":"node_modules/preact/dist/preact.mjs"}],"js/components/labelled-inline-list.js":[function(require,module,exports) {
"use strict";
...
var LabelledInlineList = function LabelledInlineList(_ref) {
  var label = _ref.label,
      item = _ref.item,
      attribute = _ref.attribute,
      groups = _ref.groups;
  ...
  return (0, _preact.h)("div", _extends({
    ...
    className: "labelled-item--item"
  }, !(0, _isEmpty.default)(item) && item.join(', ') || 'n/a'));
};

var _default = LabelledInlineList;
exports.default = _default;
},{"lodash/isEmpty":"node_modules/lodash/isEmpty.js","preact":"node_modules/preact/dist/preact.mjs"}],"js/components/search-result-item.js":[function(require,module,exports) {
"use strict";
...
var _labelledInlineList = _interopRequireDefault(require("./labelled-inline-list"));
...
var customRenders = {
  ...
  'language-arr': _labelledInlineList.default
};
...
var SearchResultItem = function SearchResultItem(properties) {
...
exports.default = _default;
},{"../utils":"js/utils.js","preact":"node_modules/preact/dist/preact.mjs","./labelled-item":"js/components/labelled-item.js","./agency-phone":"js/components/agency-phone.js","./name":"js/components/name.js","./agency-name":"js/components/agency-name.js","./labelled-inline-list":"js/components/labelled-inline-list.js"}],"js/components/search-result-list.js":[function(require,module,exports) {
"use strict";
...
var SearchResultList = function SearchResultList(_ref) {
  ...
  return (0, _preact.h)("div", {
    className: "list-group minimize"
  }, results.map(_searchResultItem.default));
};
...
exports.default = _default;
},{"preact":"node_modules/preact/dist/preact.mjs","./search-result-item":"js/components/search-result-item.js","preact-redux":"node_modules/preact-redux/dist/preact-redux.esm.js"}],"js/components/program-detail.js":[function(require,module,exports) {
"use strict";
...
function hasValues(data) {
  return data.find(function (_ref) {
    var item = _ref.item;
...
var CompletenessMarkup = function CompletenessMarkup(_ref3) {
  var data = _ref3.data;
  var options = ['Unknown', 'Partial', 'Complete'];
  var count = countGroupCompleteness(data['immigrant-accessibility']);
  var threshholdForCompleteness = 15;
  ...
  _createClass(DetailsMarkup, [{
    ...
    value: function render(_ref4) {
      ...
      return (0, _preact.h)("div", {
        ...
        for: "toggle-missing"
      }, "Show Missing Data")), (0, _preact.h)("div", {
        ...
        className: hasValues(data['eligibility']) ? '' : 'hideable'
      }, "Eligibility"), data['eligibility'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['id-details']) ? '' : 'hideable'
      }, "Identification Details"), data['id-details'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group "
      }, (0, _preact.h)("h4", {
        className: hasValues(data['requirements']) ? '' : 'hideable'
      }, "Requirements"), data['requirements'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['service-intake-details']) ? '' : 'hideable'
      }, "Sevice Intake"), data['service-intake-details'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['contact']) ? '' : 'hideable'
      }, "Contact Information"), data.contact.map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['language-support']) ? '' : 'hideable'
      }, "Language Support"), data['language-support'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['services-provided']) ? '' : 'hideable'
      }, "Services Provided"), data['services-provided'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['services-offered']) ? '' : 'hideable'
      }, "Services Offered"), data['services-offered'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", null, "Schedule"), data['schedule'].map(renderProperty)), (0, _preact.h)("div", {
        className: "list-group"
      }, (0, _preact.h)("h4", {
        className: hasValues(data['services-and-policies']) ? '' : 'hideable'
...
var ProgramDetail = function ProgramDetail(_ref5) {
  var data = _ref5.program,
      programsByAgency = _ref5.programsByAgency;
  ...
  return (0, _preact.h)("div", null, (0, _preact.h)(DetailsMarkup, {
    ...
    className: "mt-4"
  }, "All Programs by ", data.summary.find(function (_ref6) {
...
var _default = (0, _preactRedux.connect)(function (state) {
  var agencyId = state && state.get('program').data.identifiers.find(function (_ref7) {
...
exports.default = _default;
},{"preact":"node_modules/preact/dist/preact.mjs","preact-redux":"node_modules/preact-redux/dist/preact-redux.esm.js","./labelled-item":"js/components/labelled-item.js","./agency-phone":"js/components/agency-phone.js","./name":"js/components/name.js","./agency-name":"js/components/agency-name.js","./labelled-inline-list":"js/components/labelled-inline-list.js","./search-result-list":"js/components/search-result-list.js","lodash/isEmpty":"node_modules/lodash/isEmpty.js"}],"js/program.js":[function(require,module,exports) {
"use strict";
...
var _programDetail = _interopRequireDefault(require("./components/program-detail"));
...
var mapObject;
var programResultContainer = document.getElementById('program-result-container');
...
function updateMap(map, program) {
  if (program.data.location.find(function (_ref3) {
    ...
    var programLatLng = {
      lat: parseFloat(program.data.location.find(function (_ref4) {
        var attribute = _ref4.attribute;
        return attribute === 'latitude';
      }).item),
      lng: parseFloat(program.data.location.find(function (_ref5) {
...
var Program = function Program() {
  ...
  }, (0, _preact.h)(_programDetail.default, null));
};

(0, _preact.render)((0, _preact.h)(Program, null), programResultContainer);
},{"preact":"node_modules/preact/dist/preact.mjs","preact-redux":"node_modules/preact-redux/dist/preact-redux.esm.js","./constants":"js/constants.js","axios":"node_modules/axios/index.js","./utils":"js/utils.js","./data-mapper":"js/data-mapper.js","./search-filter-store":"js/search-filter-store.js","./components/program-detail":"js/components/program-detail.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
