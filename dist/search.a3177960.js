...
exports.default = _default;
},{"./labelled-item":"js/components/labelled-item.js"}],"js/components/search-result-item.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(SearchResultItem, _BaseComponent);
  ...
  _createClass(SearchResultItem, null, [{
    key: "markup",
    value: function markup(properties) {
      return "\n<a href=\"/program.html?id=".concat(properties.identifiers.find(function (_ref) {
...
exports.default = _default;
},{"./base":"js/components/base.js","./labelled-item":"js/components/labelled-item.js","./agency-phone":"js/components/agency-phone.js","./name":"js/components/name.js","./agency-name":"js/components/agency-name.js","./labelled-inline-list":"js/components/labelled-inline-list.js"}],"js/components/search-result-list.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(SearchResultList, _BaseComponent);
  ...
  _createClass(SearchResultList, null, [{
    key: "markup",
    value: function markup(properties) {
...
exports.default = _default;
},{"./base":"js/components/base.js","./search-result-item":"js/components/search-result-item.js"}],"js/search.js":[function(require,module,exports) {
"use strict";
...
var _searchResultList = _interopRequireDefault(require("./components/search-result-list"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var searchResultContainer = document.getElementById('search-result-container');
var searchResultList = new _searchResultList.default({
  items: []
}, searchResultContainer);

_axios.default.get("".concat(_constants.searchURL).concat(location.search)).then(function (_ref) {
  var data = _ref.data;
  var dataView = data.map(_utils.handleDataFromAPIToView);
