...
function getLabelAndPhone(string, index) {
  ...
  var label = string.replace(phone[0], '').trim() || "Phone ".concat(index + 1);
  return _defineProperty({}, label, phone[0]);
}
...
exports.default = _default;
},{"./base":"js/components/base.js"}],"js/components/program-detail.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./base":"js/components/base.js","./labelled-item":"js/components/labelled-item.js","./agency-phone":"js/components/agency-phone.js","./name":"js/components/name.js","./agency-name":"js/components/agency-name.js"}],"js/program-detail.js":[function(require,module,exports) {
"use strict";
...
_axios.default.get("".concat(_constants.searchURL).concat(location.search)).then(function (_ref) {
  var data = _ref.data;
  window.data = (0, _utils.handleDataFromAPIToView)(data[0]);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/program-detail.js"], null)
//# sourceMappingURL=/program-detail.be6afff4.map