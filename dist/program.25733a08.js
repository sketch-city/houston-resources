...
module.exports = exports['default'];
},{"./helper/reg_exp/const_extended":"node_modules/voca/helper/reg_exp/const_extended.js","./capitalize":"node_modules/voca/capitalize.js","./helper/string/coerce_to_string":"node_modules/voca/helper/string/coerce_to_string.js"}],"js/utils.js":[function(require,module,exports) {
"use strict";
...
function groupSettings() {
  var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants.attributeSettings;
  var grouped = {};
  Object.keys(settings).forEach(function (key, index) {
    var labelledSettings = labellizeSettings(key, index, settings);
...
function handleDataFromAPIToView(object) {
  ...
  Object.keys(object).forEach(function (key, index) {
    ...
    var viewData = dataToViewData(key, index, item);
    var _attributeSettings$ke = _constants.attributeSettings[key],
...
function labellizeSettings(key, index) {
  var settings = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _constants.attributeSettings;
...
function dataToViewData(key, index, item) {
  var _labellizeSettings = labellizeSettings(key, index, _constants.attributeSettings),
      label = _labellizeSettings.label,
      attribute = _labellizeSettings.attribute;
...
},{"date-fns":"node_modules/date-fns/index.js","voca/replace_all":"node_modules/voca/replace_all.js","voca/kebab_case":"node_modules/voca/kebab_case.js","voca/title_case":"node_modules/voca/title_case.js","./constants":"js/constants.js"}],"js/components/base.js":[function(require,module,exports) {
"use strict";
...
},{"voca/kebab_case":"node_modules/voca/kebab_case.js"}],"js/components/labelled-item.js":[function(require,module,exports) {
"use strict";
...
function (_BaseComponent) {
  _inherits(LabelledItem, _BaseComponent);

  function LabelledItem() {
    _classCallCheck(this, LabelledItem);

    return _possibleConstructorReturn(this, _getPrototypeOf(LabelledItem).apply(this, arguments));
  }

  _createClass(LabelledItem, null, [{
    key: "renderItem",
...
exports.default = _default;
},{"./base":"js/components/base.js"}],"js/components/agency-phone.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(AgencyPhone, _BaseComponent);

  function AgencyPhone() {
    _classCallCheck(this, AgencyPhone);

    return _possibleConstructorReturn(this, _getPrototypeOf(AgencyPhone).apply(this, arguments));
  }

  _createClass(AgencyPhone, null, [{
    key: "markup",
    value: function markup(properties) {
      ...
      return "\n".concat(properties.item.map(_labelledItem.default.markup).join(''), "\n    ");
    }
  }]);
...
exports.default = _default;
},{"./base":"js/components/base.js","./labelled-item":"js/components/labelled-item.js"}],"js/components/name.js":[function(require,module,exports) {
"use strict";
...
var _default = Name;
exports.default = _default;
},{"./base":"js/components/base.js"}],"js/components/agency-name.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(AgencyName, _BaseComponent);

  function AgencyName() {
    _classCallCheck(this, AgencyName);

    return _possibleConstructorReturn(this, _getPrototypeOf(AgencyName).apply(this, arguments));
  }

  _createClass(AgencyName, null, [{
    key: "markup",
    value: function markup(_ref) {
      var label = _ref.label,
          item = _ref.item,
...
exports.default = _default;
},{"./base":"js/components/base.js"}],"js/components/labelled-inline-list.js":[function(require,module,exports) {
"use strict";
...
var LabelledInlineList =
/*#__PURE__*/
function (_LabelledItem) {
  _inherits(LabelledInlineList, _LabelledItem);

  function LabelledInlineList() {
    _classCallCheck(this, LabelledInlineList);

    return _possibleConstructorReturn(this, _getPrototypeOf(LabelledInlineList).apply(this, arguments));
  }

  _createClass(LabelledInlineList, null, [{
    key: "renderItem",
    value: function renderItem(item) {
      return "\n".concat(item.join(', '), "\n    ");
    }
  ...
  return LabelledInlineList;
}(_labelledItem.default);

var _default = LabelledInlineList;
exports.default = _default;
},{"./labelled-item":"js/components/labelled-item.js"}],"js/components/program-detail.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_BaseComponent) {
  _inherits(ProgramDetail, _BaseComponent);

  function ProgramDetail() {
    _classCallCheck(this, ProgramDetail);

    return _possibleConstructorReturn(this, _getPrototypeOf(ProgramDetail).apply(this, arguments));
  }

  _createClass(ProgramDetail, null, [{
    key: "markup",
    value: function markup(_ref2) {
      var data = _ref2.data;
...
var _default = ProgramDetail;
exports.default = _default;
},{"./base":"js/components/base.js","./labelled-item":"js/components/labelled-item.js","./agency-phone":"js/components/agency-phone.js","./name":"js/components/name.js","./agency-name":"js/components/agency-name.js","./labelled-inline-list":"js/components/labelled-inline-list.js"}],"js/program.js":[function(require,module,exports) {
"use strict";
...
var programDetail = new _programDetail.default({
  data: {}
}, programResultContainer);

_axios.default.get("".concat(_constants.searchURL).concat(location.search)).then(function (_ref) {
  var data = _ref.data;
  programDetail.update({
    data: (0, _utils.handleDataFromAPIToView)(data[0])
  });
